...
class UserService:
    ...
    async def get_all_users(self) -> list[dict]:
        ...
        query = text("SELECT users.id, users.username, users.email, users.is_active, users.role_id, roles.name FROM users INNER JOIN roles ON users.role_id = roles.id ORDER BY id ASC;")
